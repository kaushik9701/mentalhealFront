...
export default function HomePage({ user }) {
  ...
  return (
    ...
    >
      {/* Onboarding Modal */}
      {showOnboarding && user && (
        <OnboardingFlow setShowOnboarding={setShowOnboarding} />
      )}
      ...
      <div className="relative z-10 max-w-6xl mt-14 mx-auto px-4 py-12 md:py-24">
        ...
        <div className="grid md:grid-cols-2 pt-32 sm:pt-1 gap-8 mb-16">
          {user ? (
            ...
            <>
              <div className="bg-white/10 border border-white/20 shadow-lg rounded-2xl p-8 ring-1 ring-white/10">
                <div className="flex items-center gap-3 mb-6">
        ...
        >
          <Link to="/journal" className="inline-block relative group">
