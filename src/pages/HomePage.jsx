...
import BackgroundScene from "../Animations/CosmicScene";
          ...
          {user ? (
            <div className="space-y-6">
              <motion.h1 
                ...
                className="text-4xl md:text-6xl pt-56 sm:pt-16 font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent"
              >
              ...
              >
                <div className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-lg p-3 ring-1 ring-white/10 text-sm">
            ...
            <div className="space-y-8">
              ...
              >
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/10 to-pink-700/15 rounded-lg blur opacity-75 animate-pulse"></div>
                  <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-2xl p-3 ring-1 ring-white/10 text-sm">
        ...
        <div className="grid md:grid-cols-2 pt-32 sm:pt-1 gap-8 mb-16">
          {user ? (
            ...
            <>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-2xl p-8 ring-1 ring-white/10"
              >
                ...
                <div className="space-y-6">
                  <div className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-2xl p-4 ring-1 ring-white/10">
              ...
              <Link to="/insight" className="block">
                ...
                >
                  ...
                  <div className="space-y-6 text-purple-100">
                    <div className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-2xl p-3 ring-1 ring-white/10">
            ...
            <>
              <motion.div 
                ...
                <div className="space-y-4">
                  <div className=" gap-3 bg-black/30 backdrop-blur-md border border-white/10 shadow-md py-2 rounded-lg flex items-center pl-7
">
...
>                 
                ...
                <div className="grid gap-4">
                  ...
                  <Link
                    to="/login"
                    className=" bg-black/30 backdrop-blur-md border border-white/10 shadow-md py-3 flex items-center justify-center rounded-lg transition-all duration-300 hover:bg-purple-900/30"
                  >
        ...
        >
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-pink-500 rounded-xl blur opacity-75 group-hover:opacity-100 transition-opacity duration-300"></div>
            <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-2xl p-3 ring-1 ring-white/10 text-lg font-medium transition-all duration-300 group-hover:scale-105 ">
              {user ? (
                <span className="flex items-center justify-center gap-2">
      ...
      <motion.div 
        className="hidden lg:block absolute top-1/4 left-10 w-24 h-24 rounded-full bg-gradient-to-br from-purple-800 to-pink-700 shadow-lg shadow-purple-900/50"
        animate={{ y: [0, -15, 0] }}
        transition={{ repeat: Infinity, duration: 8, ease: "easeInOut" }}
      />
      <motion.div 
        className="hidden lg:block absolute bottom-1/4 right-10 w-16 h-16 rounded-full bg-gradient-to-br from-purple-600 to-indigo-700 shadow-lg shadow-purple-900/50"
        animate={{ y: [0, 15, 0] }}
