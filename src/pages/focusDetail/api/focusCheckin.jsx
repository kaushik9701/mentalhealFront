...
export function DailyCheckin({ setShowFocusPanel, objectiveId }) {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-2xl mx-auto bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-purple-800/50 p-4 sm:p-6"
    ...
    >
      ...
      <div className="p-5 border-b border-purple-900 flex justify-between items-center">
        ...
        What progress did you make today toward your objective? Did you face any challenges, learn something new, or take a small step forward?
        </h2>
        <button
